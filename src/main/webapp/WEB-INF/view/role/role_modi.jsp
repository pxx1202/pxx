...
<meta charset="UTF-8">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath }/role/updateRole.do" method="get" class="main_form">
                ...
                <div class="input_info_high">
                    <div class="input_info_scroll">
                        <ul>
                        	...
                        	<c:forEach items="${role.lp}" var="rolepriv">
                        		<c:if test="${rolepriv.pid==priv.pid }">
                        			checked="checked";
                        		</c:if>
                        	</c:forEach> />${priv.by001 }</li>
                        	</c:forEach>
                        </ul>
